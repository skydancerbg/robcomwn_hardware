...
#define MOTOR_MAX_RPM 120                   // motor's max RPM          
#define MAX_RPM_RATIO 0.85                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO          
#define MOTOR_OPERATING_VOLTAGE 12          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 12          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 12     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 3230 //3072 //144000              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 3319 //3072 //144000              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 3237 //3072 //144000              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 3253 //3072 //144000              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.10                 // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.30            // distance between middle left and middle right wheels
#define PWM_BITS 8                          // PWM Resolution of the microcontroller
#define PWM_FREQUENCY 20000     // PWM Frequency - from: https://www.pjrc.com/teensy/td_pulse.html for Teensy 3.2 at 72 MHz уп то 140625 
